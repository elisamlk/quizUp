...
import {
  AfricaMap,
} from "@/app/jeux/defi-carte/AfricaMap";
...
export function AfricaMapGame() {
  ...
  function getShareText() {
    return `J'ai trouvé ${foundCodes.length} pays sur ${AFRICA_COUNTRIES.length} au Défi Carte Afrique sur QuizUp ! 🌍`;
  }
  ...
  async function shareResult() {
    ...
    try {
      ...
      /*
       * AbortError = l'utilisateur a simplement
      ...
      console.error(
        "Erreur lors du partage du Défi Carte Afrique :",
        error
      );
    } finally {
      setIsSharing(
            ...
            {!isStarted ? (
              ...
              <div className="mapGame__inputContainer">
                <input
                  ...
                  aria-label="Nom d'un pays africain"
                />
              </div>
            )}
          </div>
