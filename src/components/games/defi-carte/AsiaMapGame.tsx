...
import {
  AsiaMap,
} from "@/app/jeux/defi-carte/AsiaMap";
...
export function AsiaMapGame() {
  ...
  function getShareText() {
    return `J'ai trouvé ${foundCodes.length} pays sur ${ASIA_COUNTRIES.length} au Défi Carte Asie sur QuizUp ! 🌏`;
  }
  ...
  async function shareResult() {
    ...
    try {
      ...
      console.error(
        "Erreur lors du partage du Défi Carte Asie :",
        error
      );
    } finally {
      setIsSharing(
            ...
            {!isStarted ? (
              ...
              <div className="mapGame__inputContainer">
                <input
                  ...
                  aria-label="Nom d'un pays asiatique"
                />
              </div>
            )}
          </div>
