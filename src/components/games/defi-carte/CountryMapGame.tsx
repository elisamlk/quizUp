...
import {
  EuropeMap,
} from "@/app/jeux/defi-carte/EuropeMap";
...
export function CountryMapGame() {
  const [
    isStarted,
    setIsStarted,
  ] = useState(false);
  ...
  function getShareText() {
    return `J'ai trouvé ${foundCodes.length} pays sur ${europeCountries.length} au Défi Carte Europe sur QuizUp ! 🌍`;
  }
  ...
  async function shareResult() {
    ...
    try {
      ...
      console.error(
        "Erreur lors du partage du Défi Carte Europe :",
        error
      );
    } finally {
      setIsSharing(
            ...
            {!isStarted ? (
              ...
              <div className="mapGame__inputContainer">
                <input
                  ...
                  aria-label="Nom d'un pays européen"
                />
              </div>
            )}
          </div>
